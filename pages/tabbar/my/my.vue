		...
		<view class="my-content">
			<view class="my-content__list" @click="open">
				<view class="my-content__list-title">
					<uni-icons class="icons" type="contact" size="18" color="#666"></uni-icons>
					<text>我的文章</text>
				</view>
				<uni-icons type="arrowright" size="24" color="#666" ></uni-icons>
			</view>
			<view class="my-content__list" @click="openFeedback">
				<view class="my-content__list-title">
					<uni-icons class="icons" type="help" size="18" color="#666"></uni-icons>
					<text>意见反馈</text>
				</view>
				<uni-icons type="arrowright" size="24" color="#666"></uni-icons>
			</view>
